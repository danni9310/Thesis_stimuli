...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\UDEA-MAESTRIA\\Proyecto\\Estimulos\\Iniciales\\dots.py',
...
dots = visual.DotStim(
    ...
    nDots=226, dotSize=22,
    speed=0.1, dir=0, coherence=1,
    fieldPos=(0.0, 0.0), fieldSize=30,fieldShape='circle',
