...
for i in range(0, 3):
    ...
    if active:
        ...
        colors = ((green, red, blue, yellow, blue, black, red, blue, green, black, red, yellow, green, blue, black),
                  (red, yellow, red, blue, yellow, blue, yellow, green, green, blue, red, green, yellow, black, green),
                  (blue, black, yellow, green, black, red, yellow, black, green, blue, red, blue, yellow, green, blue))
        screen.fill((255,255,255))
